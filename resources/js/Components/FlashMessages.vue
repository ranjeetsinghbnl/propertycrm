<template>
  <div v-if="$page.props.flash">
    <div v-if="$page.props.flash.success && show" class="flex items-center justify-between mb-12 bg-green-500 rounded">
    ...
    <div v-if="($page.props.flash.error || Object.keys($page.props.errors).length > 0) && show" class="flex items-center justify-between mb-12 bg-red-500 rounded">
      <div class="flex items-center">
