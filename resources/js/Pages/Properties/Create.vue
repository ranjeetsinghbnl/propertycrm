    ...
    <AuthenticatedLayout>
        <div scroll-region class="md:flex-1 px-4 py-8 md:p-12 md:overflow-y-auto">
            ...
            <h1 class="mb-8 text-3xl font-bold">
                ...
                <span class="text-indigo-400 font-medium pl-2">/</span> Create
            </h1>
                ...
                <form @submit.prevent="submit">
                    <div class="flex flex-wrap -mb-8 -mr-6 p-8">
                        <div class="pr-6 pb-8 w-full lg:w-1/2">
                            ...
                            <TextInput id="county" v-model="form.county" type="text" class="mt-1 block w-full" autofocus autocomplete="county" placeholder="County" />
                        ...
                        <div class="pr-6 pb-8 w-full">
                            <FileInput v-model="form.image_full" :error="form.errors.image_full" class="pb-8 pr-6 w-full lg:w-1/2" type="file" accept="image/*" label="Image" />
                            <!-- <InputError class="mt-2" :message="form.errors.image_full" /> -->
                        </div>
                    </div>
                    <div class="flex items-center justify-end px-8 py-4 bg-gray-50 border-t border-gray-100">
                        <PrimaryButton class="ml-4" :class="{ 'opacity-25': form.processing }" :disabled="form.processing" :loading="form.processing"> Create Property </PrimaryButton>
                    </div>
                </form>
            </div>
        </div>
